...
import com.altopay.lib.utils.AltoPayAppUtil;
...
public class RSAConfig implements OnSharedPreferenceChangeListener {
	...
	//SDK密码加密
	private volatile String publicKey_pwd_pay = "";
	private volatile String publicKey_pwd_login = "";
	...
	private RSAConfig() {
		SharedPreferences pref = AltoPayAppUtil.getInstance().getContext().getSharedPreferences(PUBLIC_KEY_FILE, Context.MODE_PRIVATE);
